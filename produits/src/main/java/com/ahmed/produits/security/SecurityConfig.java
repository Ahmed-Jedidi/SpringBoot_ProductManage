...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/creerCategorie").hasAnyRole("ADMIN","AGENT");
		http.authorizeRequests().antMatchers("/saveCategorie").hasAnyRole("ADMIN","AGENT");
		http.authorizeRequests().antMatchers("/ListeCategories").hasAnyRole("ADMIN","AGENT","USER");
		http.authorizeRequests().antMatchers("/supprimerCategorie","/modifierCategorie").hasRole("ADMIN");
